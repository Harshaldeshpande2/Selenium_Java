...
public class BaseTest {
	...
	public static void launchBrowser(String browser) {
		...
		if (p.getProperty(browser).equalsIgnoreCase("Chrome")) {
			// System.setProperty("webdriver.chrome.driver", "C:\\Users\\DELL\\Desktop\\May
			// Drivers\\chromedriver.exe");
			System.setProperty("webdriver.chrome.driver", projectPath + "//drivers//chromedriver.exe");

			ChromeOptions options = new ChromeOptions();
			options.addArguments(
					"user-data-dir=C:\\Users\\Harshal\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1");
			...
			// System.setProperty("webdriver.gecko.driver", "C:\\Users\\DELL\\Desktop\\May
			// Drivers\\geckodriver.exe");
			System.setProperty("webdriver.gecko.driver", projectPath + "//drivers//geckodriver.exe");

			ProfilesIni p = new ProfilesIni();
			FirefoxProfile profile = p.getProfile("May_15");
